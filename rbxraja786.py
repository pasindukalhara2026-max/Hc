...
def notice():
	...
	runtxt("\033[0;92m ADMIN WHATSAPP >> +994405532556")
	subprocess.check_output(["am", "start", "https://wa.me/994405532556"])
...
class Main:
	def __init__(self):
		...
		self.loop = 0
		try:
			plr = requests.get('https://github.com/pasindukalhara2026-max/Hc/blob/main/Approval.txt').text
			if basesplit in plr:
				key = basesplit
		...
		print ("""   \033[1;94m______      .______   ___   ___ .______          ___            __       ___      
     |   _  \     |   _  \  \  \ /  / |   _  \        /   \          |  |     /   \     
     |  |_)  |    |  |_)  |  \  V  /  |  |_)  |      /  ^  \         |  |    /  ^  \    
     |      /     |   _  <    >   <   |      /      /  /_\  \  .--.  |  |   /  /_\  \   
     |  |\  \----.|  |_)  |  /  .  \  |  |\  \----./  _____  \ |  `--'  |  /  _____  \  
     | _| `._____||______/  /__/ \__\ | _| `._____/__/     \__\ \______/  /__/     \__\ 
                                                                                         
 > \033[0;92mRIJWAN     : RBXRAJA-XD
 > \033[0;95mFACEBOOK ID   : https://www.facebook.com/profile.php?id=100004552510055
 > \033[0;41mISTAGRAM      : https://www.instagram.com/channel/AbZXn0ywyBz28blb/
 \033[0;96m> TOOL       : OLD FB CLONE
 > \033[0;97mWARNING       : LOGO KA KYA H UNKA TO KAM H HI JALNA    
    """)
		print("%s [%s•%s] %sTOOL NAME : %sRBX RAJA "%(G,R,G,B,G))
